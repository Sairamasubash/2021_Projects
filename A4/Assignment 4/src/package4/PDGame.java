/********************************************************************************
 CSCI 470     Assignment 4 - PDGame class     Spring 2021
 ...
 Purpose: The purpose of this PDGame class is to create four instance variables,
          ...
          variables, and a method called playRound (which requires other small
          methods). The components of this PDGame class will mostly be used/called
          in the main PDGameGui function (just like the GameStat class).
 *******************************************************************************/
package package4;   // Here we are stating that this PDGame.java file is located in package4.
...
public class PDGame
{
   ...
   public PDGame()
   {
      ...
      strategiesArrayList.add("Tit-For-Tat");
      strategiesArrayList.add("Tit-For-Two-Tats");
      strategiesArrayList.add("Random Choice by Computer");
   }
